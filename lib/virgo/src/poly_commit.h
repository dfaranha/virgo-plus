    ...
    namespace poly_commit {
        ...
        public:
            ...
            __hhash_digest commit_private_array(fieldElement *private_array, int log_array_length,
                ...
                fieldElement *tmp;
                tmp = new fieldElement[std::max(mask_size_after_padding, slice_real_ele_cnt)];
            ...
            __hhash_digest
            commit_public_array(std::vector<fieldElement> &all_pub_msk, fieldElement *public_array, int r_0_len,
                                fieldElement target_sum, fieldElement *all_sum) {
                std::chrono::high_resolution_clock::time_point t0 = std::chrono::high_resolution_clock::now();
